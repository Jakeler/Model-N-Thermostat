...
//#include "compiler.h"
#define _SFR_(mem_addr, name)  (#define name (*(volatile uint8_t *)(0x5000 + (mem_addr))))
...
//#define SYSCFG_RMPCR1 _SFR_(0x509E)
//_SFR_(0x509E,SYSCFG_RMPCR1)
//SFR(SYSCFG_RMPCR1, 0x509E)
__sfr __at (0xD0) PSW;
